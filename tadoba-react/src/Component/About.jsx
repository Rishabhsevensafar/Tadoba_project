    ...
    <>
      ...
      >
        <div className="container">
          <div className="row ">
            <div className="d-none d-md-block col-lg-3 col-md-3 col-sm-12 aboutImages p-0">
              <div>
                <img src={about1} alt="" />
                <img src={about2} alt="" />
              </div>
            ...
            <div className="col-lg-9 col-md-9 col-sm-12">
              <div className="homeabout px-lg-3 px-md-3">
                ...
                <p>
                  Tadoba Andhari Tiger Reserve and Sanctuary is one of the noted
                  wildlife destination popular for Tiger Safari in India. It is
                  located in Chandrapur district which lies in the state of
                  Maharashtra, India. Its name Tadoba has been derived from the
                  Tribal god honoured in this region Taru or Tadoba and the
                ...
                <p>
                  ...
                  world in the terms of working, methods and services quality.
                  We invented and carved a platform where you can just enter and
                  get an access to travel India. We are the revolutionary
                  entrepreneurs in the wildlife tourism world in the terms of
                  working, methods and services quality. We invented and carved
                  a platform where you can just enter and get an access to
                  travel India.
                </p>
              </div>
            </div>
            <div className="d-block d-md-none col-lg-3 col-md-3 col-sm-12 aboutImages p-0">
              <div>
                <img src={about1} alt="" />
                <img src={about2} alt="" />
              </div>
