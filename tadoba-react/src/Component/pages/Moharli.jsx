...
import tigerMaharli from "../../assets/images/tiger.jpg";
import safarigate from "../../assets/images/tour-package4.jpg";
      ...
      <div className="container">
          ...
          <div className="row">
            <div className="col-sm-12 col-md-8 col-lg-8 pe-lg-3">
              ...
              <p>
                ...
                the wildlife enthusiast and ultimatum is the very close view of
                Tiger. It is located in Chandarpur District in Maharashtra. It’s
                not rare in Tadoba to sight a tiger and you can be fortunate
                enough to have the best of the moments with your friends and
                family. The green beautiful backdrop of the forest and rich and
                an interesting variety of flora and fauna in Tadoba Tiger
                Reserve captivates the tourists immediately.Tadoba is not
                housing only 115 tigers but also encompasses wild animals such
                as Wolf, Bison, Spotted Deer, Barking Deer, Chinkara, Sambar,
                Hyena, Nilgai, Langur, and Wild Boar. Tadoba Tiger Safari is the
                real time bliss for those who have a penchant for spotting
                ‘Royal Bengal Tiger’. The photography activities can be done in
                abundance as you will get different and unique backdrops for
                wildlife.
              </p>
              </div>
            </div>
            <div className="col-sm-12 col-md-4 col-lg-4">
              <img className="moharliSafariImg" src={safarigate} alt="" />
            </div>
            <h6>
        ...
        <section className="section">
          ...
          <div className="row">
            ...
            <div className="col-sm-12 col-md-4 col-lg-4">
              <img className="moharliSafariImg" src={tigerMaharli} alt="" />
            </div>
          </div>
        </section>
        <section>
        ...
        <div className="row">
          ...
          <div>
            ...
            <li>
              Book your permit through the gates which are close to your resort.
            </li>
            <li>All the buffer gates will be closed on Wednesday from Feb 1</li>
            <li>
              Visitors are required to get hands on entry permits that are being
              subjected to receive online (by producing above mentioned
              documents)
            </li>
            <li>
              The entry permit to the Tadoba National Park is provisional and
              can be changed or cancelled without any prior information.
            </li>
            <li>
              The rules are made by Tadoba Tiger Reserve Director and we have to
              follow the guidelines.
            </li>
            <li>
              Registered guides are pre-decided so please do not make a change
              in the guide or naturalist.
            </li>
          </div>
          </div>
          <div className="col-sm-12 col-md-6 col-lg-6">
            ...
            <li>
              All visitors to the Tadoba National Park have to follow the rules
              and regulations.
            </li>
          </div>
          </div>
