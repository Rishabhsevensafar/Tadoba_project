            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="col-sm-12 col-md-8 col-lg-8 pe-lg-3">
                        ...
                        <p>
                            Navegaon Gate is one of the best core gates in Tadoba
                            national Park. The distance from Nagpur to the Navegaon gate
                            is 140 km. Daily safari permits the entry of six vehicles
                            each morning and evening for tiger safari from this gate.
                            Navegaon gate is no less than kolara and moharali gate at
                            Tadoba tiger Reserve. Jungle structure is also mind blowing
                            and all the roots are very clear and not confusing like
                            other national parks. Resorts here are also very worth
                            trying and you will avail with all amenities and facilities.
                            This gate is very peaceful and far from the hustle bustle of
                            town. No wonder the forest has the full potential to
                            entertain you with a better sighting experience. In order to
                            explore the jungle you have only 6 vehicles allowed each
                            morning and evening.
                        </p>
                        <p>
                            Safaris to this gate are an absolute treat for your gateway.
                            You cannot afford to miss out the impeccable beauty of
                            Tadoba via safari and in this area you are bound to get more
                            that you wish to have. Choosing the right gates in the right
                            zone plays a vital role in as tiger sightings depends on
                            this fact. Your priorities should match with the park
                    ...
                    <div className="col-sm-4 col-md-4 col-lg-4">
                        <img className="navegaonSafariImg" src={navegaon1} alt="" />
                        <img className="navegaonSafariImg" src={navegaon2} alt="" />
                    </div>
                </div>
                <div>
                ...
                <div className="navegaonnotes">
                    <div className="row">
                        <div className="col-sm-12 col-md-12 col-lg-12">
                            ...
                            <li>
                                In order to visit the Navegaon Gate, you must have an entry
                            ...
                            <li>
                                ...
                                entry in the tiger reserve area. Six adults and two children
                                are allowed in jeep safari and driver and guide will also be
                                there.
                            </li>
                            <li>
                                Booking in advance is always better for Tadoba tiger reserve
                                Navegaon Gate as there is always a rush of tourists for the
