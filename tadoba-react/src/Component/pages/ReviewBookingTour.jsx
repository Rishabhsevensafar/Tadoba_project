      ...
      <div className="booking leaf">
        ...
        <div className="container">
          <div className="tourBooking">
            ...
            <h4>Tour Booking Information</h4>
            <hr />
            <h3>Tadoba Weekend Tour - 1 Night and 2 Days</h3>
            <p>Near Chandrapur, Nagar</p>
            <div className="row checkInRow">
              <div className="col-sm-12 col-md-4 col-lg-4">
                <p>Check In</p>
                <h6>Fri 31 Jan 2025</h6>
                <p>Total Guest: Adults:2 Children: 0</p>
              </div>
              <div className="col-sm-12 col-md-4 col-lg-4"> 1 Night/2 Days</div>
              <div className="col-sm-12 col-md-4 col-lg-4">
                <p>Check Out</p>
                ...
                >
                  <div className="popupBox1">
                    ...
                    <ul>
                      ...
                      <li>Jeep & Canter Safari amount are non refundable.</li>
                    
                    </ul>
                    Note: Tour cost is calculated after deducting the safari amount
                                     </div>
                </Popup>
